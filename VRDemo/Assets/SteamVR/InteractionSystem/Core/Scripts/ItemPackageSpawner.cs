...
namespace Valve.VR.InteractionSystem
{
	...
	public class ItemPackageSpawner : MonoBehaviour
	{
		...
		public bool allowTwoOneHanded = false;
		...
		private void OnHandHoverBegin( Hand hand )
		{
			...
			{
				ControllerButtonHints.ShowTextHint( hand, Valve.VR.EVRButtonId.k_EButton_Grip, "PickUp" );
			}
		}
		...
		private void HandHoverUpdate( Hand hand )
		{
			...
			{
				if ( hand.controller != null && hand.controller.GetPressDown(SteamVR_Controller.ButtonMask.Grip) )
				{
					SpawnAndAttachObject( hand );
				}
			}
		...
		private void SpawnAndAttachObject( Hand hand )
		{
			if ( hand.otherHand != null )
			{
				...
				if ( otherHandItemPackage == itemPackage && !allowTwoOneHanded)
				{
